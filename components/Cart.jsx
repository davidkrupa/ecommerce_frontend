...
import { AiOutlineMinus, AiOutlinePlus, AiOutlineLeft, AiOutlineShopping, AiOutlineCloseCircle } from "react-icons/ai"
              ...
              <div className="product" key={index}>
                ...
                <div className="item-desc">
                  ...
                  <div className="flex bottom">
                    ...
                    <button type="button" className="remove-item" onClick={() => onRemove(item, item._id)}>
